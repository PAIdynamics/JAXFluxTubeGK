...
A differentiable JAX constructor now implements that two-node boundary slice,
...
error.  The parallel-path mixed derivative is therefore the dominant remaining
compact-case coefficient target; general mu grids also require interior
formulas.
...
error.  Only the two small compact-grid components and the general interior-mu
extension remain at this coefficient layer.
...
$L_2$.  Thus only the small mixed-mu component remains for the compact grid.
