    ...
    return (
        ...
        ValidationConfidenceGap(
            ...
            evidence=(
                ...
                "an exact row-sum CFL bound. Its opt-in discrete field-particle "
                "completion preserves per-species density and combined momentum/energy "
                "to roundoff, but its exchange coefficients lack independent Landau "
                "field-particle parity. "
