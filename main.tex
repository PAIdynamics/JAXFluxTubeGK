...
compact \texttt{time.dat} convention, but a richer GKW amplitude or potential
history is still needed to isolate the remaining selected-mode history gap.
...
\path{figures/cyclone_growth_diagnostic_convention_comparison.csv}.
...
\begin{figure}[htbp]
  ...
  production-control physical trace comparisons.}
