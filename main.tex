...
Second, a calibrated reduced RH crossing gate records the deterministic
\(N_z=16,N_{v_\parallel}=16,N_\mu=8,\Delta t=0.01,N_t=620\) point where the
present collisionless discretization crosses the documented residual.  It is a
regression hook, not a physical replacement for the \(t>80\) residual plateau.
