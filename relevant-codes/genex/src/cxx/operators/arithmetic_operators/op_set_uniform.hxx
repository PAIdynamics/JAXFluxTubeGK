#ifndef OP_SET_UNIFORM_HXX
#define OP_SET_UNIFORM_HXX

#include "genex_cxx_env.hxx"

// C++ class which corresponds to the Fortran class op_set_uniform_gpu_t
class op_set_uniform_gpu_t
{
public:
    // Default constructor
    op_set_uniform_gpu_t() = default;

    // Default destructor
    virtual ~op_set_uniform_gpu_t() = default;
    ...
    // Return 0 for success and 1 for error
    virtual int32_t apply(const int64_t size_y, const int32_t a,
