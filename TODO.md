...
- [ ] Use the multi-time GKW velocity-slice series to compare solver and GKW peak-\(\phi\) velocity slices over early, mid, and late windows; identify whether the distribution mismatch is present immediately, grows cumulatively, or is biased by the final peak-\(\phi\) location.
