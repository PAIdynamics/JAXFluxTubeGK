"""Public API for the provider-neutral JAX flux-tube gyrokinetic solver."""
...
from .physics import (
    ...
    s_alpha_curvature_drift_profile,
...
try:
    __version__ = version("jax-fluxtube-gk")
except PackageNotFoundError:  # Source-tree imports without an editable install.
