...
toy circular-geometry coefficient modulation with Boozer/DESC/precomputed
geometry arrays and to optimize only after the Rosenbluth-Hinton, Cyclone Base
Case, and GX/eik benchmark checks are stable.
...
\begin{enumerate}
  ...
  \item Boozer/stellarator geometry adapter.
