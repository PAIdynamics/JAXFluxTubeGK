...
- [ ] Generate or load the matched GKW source-term, residual, state-history, or restart/final-state trace and compare it against the solver source-term trace rather than adding more diagnostic sign variants.
...
- [ ] Generate or load the matched GKW state-history, source-term time trace, or restart/final-state dump and compare it against the solver source-term trace after Term VII and simple fused-`igh` sign paths are ruled out.
