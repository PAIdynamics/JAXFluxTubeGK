...
```bash
uv run python scripts/prepare_stella_w7x_rhs_trace_run.py --stella-source ../stella --vmec-file ../gx/benchmarks/linear/ITG_w7x/wout_w7x.nc --overwrite --output-root /tmp/stellarator_gk_stella_w7x_rhs_trace
