...
- compare remaining GKW matrix/time-history construction paths beyond Term I, normalization, and field diagnostics, especially `matdat.F90` coefficient assembly/compression and any source-term or matrix-format conventions not yet mirrored by the matrix-free residual;
