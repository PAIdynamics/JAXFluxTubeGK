...
growth, and fitted growth.  On the reduced grid
...
tolerance \(2\times10^{-2}\).  Raw amplitudes, log-normalization, and raw
\(\phi\)/state/RHS norms are not yet used as pass criteria because Gyaradax and
this solver store per-window normalization factors differently.
