...
The current implementation now also includes ten validation-hardening tools.
...
is therefore not the separated Term II/IV/V/VII/VIII coefficient formulas, but
the production GKW \texttt{ltrapping\_arakawa} path that fuses the Term I/IV
Hamiltonian stencil and applies the \(\texttt{disp\_vp}=0.2\) convention.
