...
\path{figures/cyclone_igh_arakawa_audit.csv}.  The next implementation step is
to promote this source reconstruction into an optional matrix-free GKW
\texttt{igh} RHS backend and rerun the production selected-\(k_y\)
