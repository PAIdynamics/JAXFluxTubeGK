...
tolerance \(2\times10^{-2}\).  Raw amplitudes and raw log-normalization are not
yet used as pass criteria because Gyaradax and this solver store per-window
normalization factors differently.
...
\begin{figure}[htbp]
  ...
  CSV passes the reduced physical trace comparison.}
