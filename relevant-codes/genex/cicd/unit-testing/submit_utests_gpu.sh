#!/bin/bash -l
#SBATCH -J genex_utests_gpu
#SBATCH -o utests_gpu.out
#SBATCH --nodes=1
...
if [[ $MACH_NAME == "MPCDF Viper-CPU" ]]; then
	...
	echo "== Remove this in unit-testing/submit_utests_gpu.sh if possible.   =="
	echo "====================================================================="
	echo ""
    fi
fi
ctest --test-dir ../src/ --output-on-failure -R "utests-gpu"
