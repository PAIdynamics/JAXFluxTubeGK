...
- implement an optional matrix-free GKW `ltrapping_arakawa` fused `igh` backend for the solver residual, including the combined Term I/IV Hamiltonian stencil and `disp_vp=0.2`, then rerun the production selected-`ky` growth/profile gates;
