...
- [ ] Trace the selected-mode Term VII \(k_y\)/Fourier sign and field-packing path at source level, including GKW `mode.F90`, `dist.F90::get_phi`, `linear_terms.F90::vpgrphi_3_newbc`, and the real/complex storage convention, before promoting any diagnostic Term VII sign/conjugation variant into the solver.
