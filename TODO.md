...
- [ ] Extend Gyaradax/GKW trace comparison to production-control resolution and raw normalization-equivalent phi/state/RHS norms.
...
- add normalization-equivalent physical phi/state/RHS norm comparisons instead of raw normalized norms;
