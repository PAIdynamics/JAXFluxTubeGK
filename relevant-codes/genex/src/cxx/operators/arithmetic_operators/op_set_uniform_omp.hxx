#ifndef OP_SET_UNIFORM_OMP_HXX
#define OP_SET_UNIFORM_OMP_HXX
...
// with OpenMP on CPU
class op_set_uniform_omp_t: public op_set_uniform_gpu_t
{
public:
    // Default constructor
    op_set_uniform_omp_t() = default;

    // Default destructor
    virtual ~op_set_uniform_omp_t() = default;
    ...
    {
        #pragma omp parallel for simd default(none) shared(size_y, a, y) \
            schedule(static)
    ...
    {
        #pragma omp parallel default (none) shared(size_y, a, y)
