...
The current implementation now also includes seven validation-hardening tools.
...
\path{figures/cyclone_time_normalization_audit.csv}.  The next CBC parity
step is therefore to inspect GKW matrix construction, diagnostic output, and
remaining field/index packing conventions beyond Term I and normalization.
