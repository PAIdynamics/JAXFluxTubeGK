#ifndef OP_COPY_ACC_HXX
#define OP_COPY_ACC_HXX
...
// with OpenACC on GPU
class op_copy_acc_t: public op_copy_gpu_t
{
public:
    // Default constructor
    op_copy_acc_t() = default;

    // Default destructor
    ~op_copy_acc_t() override = default;
    ...
    {
        #pragma acc parallel default(none) copyin(size_y) present(x, y)
