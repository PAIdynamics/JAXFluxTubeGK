...
the matched external W7-X fixture and true production CPU timing exist. The current
benchmark-informed
...
- `fixtures/w7x_itg_convergence_study/`: reduced W7-X convergence/timing
  ...
  `production_readiness_gate.json`, an external mode-structure gate status, and
  README.
