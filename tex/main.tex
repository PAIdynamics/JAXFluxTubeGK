...
low-rank precompute without stella.  A second-state action comparison and an
explicit treatment of stella's implicit response-system solve remain required
for the production physics gate.
