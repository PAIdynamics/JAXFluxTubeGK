...
- compare remaining GKW coefficient construction paths beyond the reduced `matdat.F90` sparse convention audit, especially term insertion order and source-level coefficient formulas for Terms II, IV, V, VII, and VIII in production selected-`ky` geometry;
