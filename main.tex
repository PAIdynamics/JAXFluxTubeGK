...
The current implementation now also includes six validation-hardening tools.
...
\path{figures/cyclone_profile_operator_audit.csv}.  The next CBC parity step
is therefore to compare the selected-mode Term I streaming/upwind stencil,
sign choice, and normalization directly against the GKW Fortran path.  The
direct compact GKW comparison path uses
