...
- compare the localized `parallel_phi.dat` central-curvature/width mismatch against the parallel derivative, GKW-upwind boundary, and field-solve assembly at the selected mode;
