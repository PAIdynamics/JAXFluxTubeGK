submodule (data_storage_m) data_storage_gpu_5d_s
    ...
    interface
        integer(kind=C_INT32_T) function cbind_data_storage_5d_initialize( &
            dcomm_handler_cxx_pptr, ds_data, da_cxx_pptr, ds_cxx_pptr) &
            bind(C, name="cbind_data_storage_5d_initialize")
            !! Fortran/C++ interoperable routine for the initialization
            !! of data_storage_gpu_5d_t C++ class
        ...
        integer(kind=C_INT32_T) function cbind_data_storage_5d_start_exchange( &
            ds_cxx_pptr, ex_dim) &
            bind(C, name="cbind_data_storage_5d_start_exchange")
            !! Fortran/C++ interoperable routine for the start_exchange routine
            !! of data_storage_gpu_5d_t C++ class
            import :: C_INT32_T, C_PTR
            type(C_PTR), intent(inout) :: ds_cxx_pptr
            integer(kind=C_INT32_T), value :: ex_dim
        end function

        integer(kind=C_INT32_T) function cbind_data_storage_5d_finish_exchange(&
            ds_cxx_pptr, ex_dim) &
            bind(C, name="cbind_data_storage_5d_finish_exchange")
...
contains
    ...
    module subroutine initialize_gpu_5d(this, dcomm_handler, init_value)
        ...
        ! Initialize data_storage_gpu_5d_t C++ class,
        ! including deep copy to the device
        ierr = cbind_data_storage_5d_initialize( &
    ...
    contains
        ...
        subroutine expose_data(this, ds_data)
            ...
            ds_data%n_ex_dims = this%n_ex_dims
    ...
    module subroutine start_exchange_gpu_5d(this, ex_dim)
        ...
        ierr = cbind_data_storage_5d_start_exchange( &
                   this%data_storage_cxx_pptr, ex_dim)

        if(ierr /= 0) then
            call handle_error_gpu(GPU_ERR_START_EXCH, __LINE__, __FILE__)
        endif

        call profiler_inject("pack_5d", ierr)
        call profiler_inject("send_5d", ierr)
    ...
    module subroutine finish_exchange_gpu_5d(this, ex_dim)
        ...
        ierr = cbind_data_storage_5d_finish_exchange( &
                   this%data_storage_cxx_pptr, ex_dim)
        ...
        call profiler_inject("receive_5d", ierr)
        call profiler_inject("unpack_5d", ierr)
    ...
    module subroutine finalize_gpu_5d(this)
        ...
        ierr = cbind_data_storage_5d_finalize(this%data_storage_cxx_pptr)
