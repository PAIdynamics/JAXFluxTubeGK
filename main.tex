...
time and parallel-profile comparisons under \path{figures/}.  Thus the
initialization convention is no longer the dominant remaining explanation; the
next audit should target production GKW conventions that affect the evolved
mode history.
