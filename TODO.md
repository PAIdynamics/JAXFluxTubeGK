...
- audit the production selected-`ky` GKW `ltrapping_arakawa` fused `igh` path, especially the combined Term I/IV Hamiltonian stencil and `disp_vp=0.2` convention, against the solver's separated streaming/mirror fallback;
