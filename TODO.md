...
- [ ] Add solver full selected-mode term-action snapshots and compare them against the GKW RHS trace; `CycloneSourceTermTrace` term norms are useful but not sufficient for elementwise source-action parity.
