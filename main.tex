...
The current implementation now also includes eight validation-hardening tools.
...
is \path{figures/cyclone_diagnostic_packing_audit.csv}.  The next CBC parity
step is therefore to inspect GKW matrix/source-term construction in
\path{matdat.F90} beyond Term I, normalization, and field diagnostics.
